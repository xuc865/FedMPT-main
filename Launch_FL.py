...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--num_epoch", type=int, default=50, help="number of running epochs"
    )
    parser.add_argument(
    ...
    parser.add_argument(
        "--pa", type=float, default=0.0, help="partial annotation rate"
    )
    parser.add_argument(
        "--num_clusters", type=int, default=20, help="avail_clusters"
    )
    parser.add_argument(
        "--lr", type=float, default=0.001, help="avail_clusters"
    )
    parser.add_argument(
        "--temp", type=int, default=1, help="avail_clusters"
    )
    parser.add_argument(
        "--cond", type=int, default=4, help="avail_clusters"
    )
    parser.add_argument(
        "--lat", type=int, default=64, help="avail_clusters"
    )
    parser.add_argument(
        "--stun", type=int, default=0, help="avail_clusters"
    )
    parser.add_argument(
    ...
    parser.add_argument(
        "--seed", type=int, default=34, help="only positive value enables a fixed seed"
    )
    parser.add_argument(
        "--dataset", type=str, default='voc', help="only data seed"
    )
    parser.add_argument(
        "--saving", type=bool, default=False, help="save or not"
    )
    parser.add_argument(
    ...
    parser.add_argument(
        "--allow-resume", action="store_true", help="do not call trainer.train()"
    )
    parser.add_argument(
        "--zsl", default=None, help="do not call trainer.train()"
    )
    parser.add_argument(
        "--neg", default=2, type=float, help="do not call trainer.train()"
    )
    parser.add_argument(
        "--pos", default=1,type=float, help="do not call trainer.train()"
    )
    parser.add_argument(
        "--neda", default=False, type=bool, help="do not call trainer.train()"
    )
